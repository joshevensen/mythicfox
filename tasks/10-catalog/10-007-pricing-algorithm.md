...
- [ ] A pure-function service (e.g. `App\Services\Catalog\PriceCalculator` with a static `calculate(int $marketPrice, ?int $lowPrice, PricingRules $rules): ?int`) implements the algorithm verbatim.
- [ ] Algorithm matches the doc step-by-step:
